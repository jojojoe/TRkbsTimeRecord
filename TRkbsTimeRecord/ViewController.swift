...
/*
 ...
 描述：
 zh:
 效率暴涨，一天变48小时！时间管理大师教你如何增加自己的时间长度，掌握比别人更多的技能，刷新你对高效的认知！我们要做时间的主人而不是时间的奴隶。
 时间卡片是一款很受用户喜欢的时间管理工具，它采用了时间管理大师柳比歇夫的时间记录法，让你不必被时间所追赶，每次只需要记录自己做了什么，日复一日的记录下去，你将看见一个新的自己。
 在时间卡片里，你可以添加自己想要做的任何事情，然后在以后的生活中，只要在做这件事的时候，记录下所完成的时间，时间卡片会对你的时间进行统计，一段时间以后，你将看见自己在某件事情上面花费了多少时间。
 
 - 使用条款: https://jojojoe.github.io/TRkbsTimeRecordResours/termsofuse_zh.html
 - 隐私政策: https://jojojoe.github.io/TRkbsTimeRecordResours/private_zh.html
