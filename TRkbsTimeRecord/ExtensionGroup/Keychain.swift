...
public let KeychainAccessErrorDomain = "com.tikkishi.KeychainAccess.error"
...
class TRkbsKeychainSaveManager: NSObject {
   ...
   class func saveCoinToKeychain(iconNumber: String) {
       ...
       let keychainManager = Keychain(service: TRkbsKeychainSaveManager.keyChainServer)
          do {
